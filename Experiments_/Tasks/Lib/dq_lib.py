...
def create_files(name=""):
    path = "../Results/comp" + name + ".txt"
    f = open(path, 'w')
    f.close()
    f = open("../Results/acc.txt", 'w')
    f.close()
    f = open("../Results/cons.txt", 'w')
    f.close()
