...
def evaluate(od_method, imp_method, actual_values, predicted_values, percentage):
...
def save_results(od_method, imp_method, percentage, r2):
    path = "../Results/Air_Quality/rf_regression_mix_none_outliers.csv"
...
for imp_method in imputation_methods:
    for od_method in outlier_detection_methods:
        ...
        evaluate(od_method, imp_method, actual_values, predicted_values, percentage)
